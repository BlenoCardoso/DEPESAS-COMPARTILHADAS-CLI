...
export default function MobileLayout({ children }: MobileLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 container py-6 safe-area-bottom">
        {children}
      </main>

      {/* Bottom Navigation (opcional para mobile) */}
      <nav className="md:hidden sticky bottom-0 z-40 w-full border-t bg-card/80 backdrop-blur-xl safe-area-bottom">
